...
public class UserInterface {
	...
	/**
	 * This method, called by addAppliance(), allows the user to create a new cloth
	 * dryer to the inventory.
	 */
	...
	/**
	 * Method to print all customers who are enrolled in repair plans and which
	...
	/**
	 * This method displays the help screen, which shows the user the menu of
	 * actions.
	 */
	public void help() {
	...
	/**
	 * Collects a yes or nor response from the user and returns true if yes, false
	 * if no.
	 * 
	 * @param prompt
	 * @return
